...
{
    ///<summary>ICollectable Variable</summary>
...
///<summary>List of objects that inherity from Base</summary>
public class RoomObjects
{
    ///<summary>performs an action on every object in the list</summary>
