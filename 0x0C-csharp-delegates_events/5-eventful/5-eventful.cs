...
public class Player
{
    ...
    ///<summary>a seperate hp message event for when health is very lor or 0</summary>
    ...
    ///<summary>event to call another event but adds hpValuewarning if condition is met</summary>
